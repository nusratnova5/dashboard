                    ...
                    <div className='flex justify-center items-center gap-2'>
                        <div className="relative w-full max-w-md mx-auto">
                            <input
                                ...
                                placeholder="Search..."
                                className="w-full bg-gray-200 border border-gray-300 placeholder-gray-500 pl-12 pr-4 py-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
